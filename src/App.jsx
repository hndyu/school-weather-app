...
const App = () => {
  ...
  const [location, setLocation] = useState("Mitaka");
  ...
  return (
    <div className='w-full h-screen bg-gradientBg bg-no-repeat bg-cover bg-center flex flex-col items-center justify-center px-4 lg:px-0'>
      {errorMsg && (<div className='w-full max-w-[90vw] text-white lg:max-w-[450px] bg-[#ff208c] absolute top-2 lg:top-10 p-4 capitalize rounded-md'>
            ...
            <div className='max-w-[378px] mx-auto flex flex-col gap-y-6'>
              <div className="flex justify-between">
                <div className="flex items-center gap-x-2">
                  ...
                  <div>
                    Visibility <span className='ml-2'>{data.visivility / 1000}km</span>
                  </div>
                </div>
                <div className="flex items-center gap-x-2">
                  <div className="text-[20px]">
